 ...
 <div class="rt_content">
      ...
      <ul class="ulColumn2">
       ...
       <li>
        ...
        <input type="text" name="username" class="textbox textbox_225" value="{{$data->username}}" placeholder="会员账号..."/>
       </li>
       <li>
        <span class="item_name" style="width:120px;">登陆密码：</span>
        <input type="password" name="password" class="textbox textbox_225" value="{{$data->password}}" placeholder="会员密码..."/>
       </li>
       <li>
        ...
        <select class="select" name="rid">
          ...
          @foreach($role as $v)
          <option value="{{$v->rid}}" {{$v->rid == $data->rid?"selected":""}}>{{$v->rolename}}</option>
          @endforeach
        </select>
       </li>
       </form>
